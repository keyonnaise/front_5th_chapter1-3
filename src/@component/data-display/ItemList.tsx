...
interface Props {
  items: Item[];
  onAddItemsButtonClick(): void;
}

function ItemList({ items, onAddItemsButtonClick: _onAddItemsButtonClick }: Props) {
  ...
  const onAddItemsButtonClick = usePreservedCallback(_onAddItemsButtonClick);

  const handleFilterChange = usePreservedCallback((e: ChangeEvent<HTMLInputElement>) => {
